...
import random
import sys
#NOTE: The program prints out the accuracy on testing the Data set B.
...
def main():
    ...
    accuracy = TestTree(datasetB, tree)
    print("The prediction accuracy on DataB: {}%".format(accuracy*100))
